...
/** Same team directory as /team — About IA entry at /about/team. */
export const revalidate = 120;

export const metadata = getPublicPageMetadata("aboutTeam");

type PageProps = {
  searchParams: Promise<{ q?: string; department?: string; page?: string }>;
};

export default async function AboutTeamPage({ searchParams }: PageProps) {
  ...
  return (
    <SiteShell activePath="/about/team">
      <PageHero
