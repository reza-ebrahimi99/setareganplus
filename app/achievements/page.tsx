...
export const metadata: Metadata = {
  ...
  description:
    "افتخارات، المپیادها، پذیرش مدارس استعداد، مسابقات و گواهی‌های دانش‌آموزان مؤسسه علمی ستارگان.",
  openGraph: {
    title: "افتخارات مؤسسه علمی ستارگان",
    description:
      "نمایش عمومی موفقیت‌های دانش‌آموزان در المپیادها، مسابقات و گواهی‌ها.",
  },
};
...
export default async function AchievementsPage({ searchParams }: PageProps) {
  ...
  return (
    <SiteShell activePath="/achievements">
      <PageHero
        title="افتخارات مؤسسه علمی ستارگان"
        subtitle="المپیادها، پذیرش مدارس استعداد، مسابقات، افتخارات قلم‌چی و گواهی‌های دانش‌آموزان."
        breadcrumbs={[
