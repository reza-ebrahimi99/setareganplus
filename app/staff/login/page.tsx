...
export default async function StaffLoginPage() {
  ...
  return (
    <main className="flex min-h-dvh items-start justify-center bg-[linear-gradient(180deg,#f8fafc_0%,#eef2f7_100%)] px-4 pb-16 pt-10 sm:items-center sm:py-10" dir="rtl">
