...
const PACK_KINDS = [
  { href: "/exam", title: "بسته آزمون", body: "شب امتحان و قلم‌چی", tone: "flash" as const },
  { href: "/major", title: "بسته رشته", body: "ریاضی · تجربی · انسانی", tone: "exam" as const },
  {
...
export default async function StarBookBundlesPage() {
  ...
  return (
    <StarBookFrame activePath="/bundles" products={products}>
