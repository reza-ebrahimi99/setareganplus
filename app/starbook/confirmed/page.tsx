      ...
      <section className="starbook-hero starbook-hero-immersive relative overflow-hidden">
        ...
        <div className="relative z-[1]">
          ...
          <div className="starbook-cta-row">
            <StarBookMagnetic href="/track">پیگیری سفارش</StarBookMagnetic>
            <Link href="/" className="starbook-btn starbook-btn-ghost">
              ادامه کشف
            </Link>
            <Link href="/account/points" className="starbook-btn starbook-btn-ghost">
              دیدن XP
            </Link>
          </div>
        </div>
