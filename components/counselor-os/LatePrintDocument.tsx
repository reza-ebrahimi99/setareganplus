  ...
  return (
    <>
      <header className="counselor-report__letterhead">
        <SetareganBrandMark size={52} compact />
        <div>
    ...
    <table className="counselor-report__table counselor-report__table--repeat counselor-choice-print">
      ...
      <tbody>
        {rows.map((item) => {
          ...
          return (
            <tr key={item.id} className="counselor-choice-print__row">
              <td>
                <span className="counselor-choice-print__prio">
                  {toPersianDigits(cells.order)}
                </span>
              </td>
              <td className="counselor-choice-print__code" dir="ltr">
                {cells.code || "—"}
              </td>
              ...
              {props.showBand ? (
                <td>
                  <span
                    className={`counselor-choice-print__chance counselor-choice-print__chance--${item.band || "mid"}`}
                  >
                    {cells.band}
                  </span>
                </td>
...
export function LatePrintDocument(props: {
  ...
  if (props.kind === "choices-initial") {
    return (
      <div className="counselor-report counselor-choice-print-doc counselor-choice-print-doc--landscape" dir="rtl">
