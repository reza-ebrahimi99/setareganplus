  ...
  return (
    <form action={action} className="gv2-form" noValidate>
      ...
      {props.documentStatus ? (
        <p className={`gjv2-doc-badge gjv2-doc-badge--${props.documentStatus}`} role="status">
          وضعیت کارنامه: {props.documentStatus === "VERIFIED" ? "تأیید شده" : props.documentStatus === "REJECTED" ? "نیازمند اصلاح" : "در انتظار بررسی"}
          {props.documentNote ? ` — ${props.documentNote}` : ""}
        </p>
      ) : null}
