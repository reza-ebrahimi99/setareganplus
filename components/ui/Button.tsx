...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary:
    "bg-secondary text-primary hover:bg-secondary/90 focus-visible:outline-secondary",
  outline:
    "border border-border bg-surface text-foreground hover:bg-background focus-visible:outline-secondary",
};
