...
export default async function CounselorDashboardPage() {
  ...
  const kpis = [
    ["همه دانش‌آموزان", model.stats.totalStudents],
    ["نیازمند پیگیری", model.stats.needsFollowUp],
    ["بدون فعالیت", model.stats.noActivity],
    ["جلسات امروز", model.stats.todaySessions],
    ["جلسات آینده", model.stats.upcomingBookings],
    ["پیگیری عقب‌افتاده", model.stats.overdueFollowUps],
    ["پرونده‌های ناقص", model.stats.incompleteCases],
  ...
  return (
    <div className="cos-page">
      <header className="cos-page__hero">
        ...
        <p className="cos-page__lead">صف کار واقعی بر اساس ورود، مسیر، پرداخت و پیگیری — بدون داده ساختگی.</p>
      </header>
