...
export function CounselorStudentCaseTabs({
  ...
  const tabs: Array<[Tab, string, boolean]> = [
    ...
    ["holland", "آزمون رغبت‌سنجی", dossier.holland.completed || dossier.finance.hollandPaid],
      ...
      <div className="cos-tabs__panel">
        ...
        {tab === "holland" && (
          <section className="cos-panel">
            ...
            <p>
              {dossier.holland.completed
                ? dossier.holland.summary
                : "نتیجه آزمون هنوز در پرونده ثبت نشده است."}
            </p>
            <p className="cos-muted">
              این گزارش بر اساس داده‌های موجود سامانه است و ادعای طراحی چارچوب از صفر ندارد.
            </p>
          </section>
        )}
