      ...
      <div className="gjv2-step10">
        ...
        >
          ...
          selectedPackage?.requiresPayment ? (
            <section className="gjv2-step10-discount">
              <div className="gjv2-step10-discount__heading">
                <span>
                  <GiftIcon />
                </span>
                ...
                <div>
                  <strong>
                    قبلاً همراه ما بوده‌اید؟
                  </strong>
                  <p>
                    اگر در سال‌های گذشته در
                    یکی از کلاس‌ها، دوره‌ها،
                    آزمون‌ها یا جلسات مشاوره
                    مجموعه ستارگان / قلم‌چی
                    نسیم‌شهر شرکت کرده‌اید،
                    با ما تماس بگیرید و کد
                    تخفیف ۵۰۰ هزار تومانی
                    خود را دریافت کنید.
                  </p>
                </div>
              </div>

              <div className="gjv2-step10-discount__row">
                <label className="gjv2-step10-discount__field">
                ...
                <button
                  type="button"
                  className="gjv2-step10-discount__apply"
                  onClick={applyDiscountCode}
                  disabled={
                    discountPreviewPending || !discountCode.trim()
                  }
                >
                  {discountPreviewPending
                    ? "در حال بررسی..."
              ...
              {discountPreview ? (
                discountPreview.ok ? (
                  ...
                  >
                    کد تخفیف معتبر است.
                    قیمت اصلی {formatToman(discountPreview.originalAmountRials ?? selectedPackage.priceRials)} تومان،
                    تخفیف {formatToman(discountPreview.discountRials)} تومان،
                    مبلغ قابل پرداخت {formatToman(discountPreview.finalAmountRials)} تومان.
                  </div>
                ) : (
                  <div
                    className="gjv2-banner gjv2-banner--error"
              ...
              <p className="gjv2-step10-discount__note">
                اعتبار کد و مبلغ نهایی در سرور
                بررسی می‌شود و هنگام پرداخت نیز
                دوباره اعتبارسنجی خواهد شد.
              </p>
            </section>
          ) : null}
