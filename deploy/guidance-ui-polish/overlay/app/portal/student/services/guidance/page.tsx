...
import { GuidancePlansShowcase } from "@/components/guidance/platform/GuidancePlansShowcase";
...
import { buildGuidanceJourneyModel } from "@/lib/guidance/journey-presentation";
import {
...
> = {
  ...
  plans: {
    eyebrow: "پلن‌های انتخاب رشته",
    title: "پلن‌های ثبت‌نام انتخاب رشته ویژه مهندس رضا ابراهیمی",
    description:
      "جزئیات پلن‌های هوشمند، تخصصی و ممتاز در فاز پرداخت جدید این بخش فعال می‌شود.",
    icon: "spark",
    accent: "gold",
  },
};
