...
export function LateStepLookBackNotice(props: {
  ...
  return (
    <section className="gv2-status-card gv2-status-card--premium">
      <p className="gv2-status-card__eyebrow">مرحله تکمیل‌شده</p>
      <h2>این مرحله قبلاً تکمیل شده است</h2>
      <p>فرم این مرحله برای جلوگیری از دور زدن مسیر قفل است. برای ادامه به مرحله جاری پرونده برگردید.</p>
