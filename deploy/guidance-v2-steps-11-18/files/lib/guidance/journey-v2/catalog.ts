...
export const GUIDANCE_V2_STEPS: readonly GuidanceV2StepDefinition[] = [
  ...
  { id: 13, title: "چیدمان توسط مشاور", shortTitle: "چیدمان مشاور", description: "آماده‌سازی فهرست انتخاب‌ها توسط مشاور" },
  { id: 14, title: "بررسی ۱۵۰ انتخاب", shortTitle: "بررسی چیدمان", description: "بازخورد دانش‌آموز روی فهرست مشاور" },
  { id: 15, title: "رزرو جلسه دوم", shortTitle: "جلسه دوم", description: "جلسه نهایی بررسی انتخاب‌ها" },
  { id: 16, title: "اصلاحات نهایی", shortTitle: "اصلاحات", description: "ویرایش نهایی فهرست توسط مشاور" },
  { id: 17, title: "تأیید آگاهانه", shortTitle: "تأیید", description: "تأیید فهرست نهایی توسط دانش‌آموز" },
  { id: 18, title: "ثبت نهایی سنجش", shortTitle: "ثبت نهایی", description: "پیگیری ثبت در سامانه رسمی سازمان سنجش" },
];
