...
const SANJESH_LABELS: Record<SanjeshStatus, string> = {
  ...
  DECLARED: "اعلام ثبت توسط دانش‌آموز",
...
const ARRANGEMENT_STATE_LABELS = {
  ...
  IN_PROGRESS: "چیدمان در حال انجام",
  INITIAL_READY: "نسخه اولیه آماده بررسی",
  NEEDS_INFO: "نیازمند تکمیل اطلاعات",
  REVIEW_READY: "آماده مرحله بررسی انتخاب‌ها",
  FINAL_IN_PROGRESS: "اصلاحات نهایی توسط مشاور در حال انجام است",
  FINAL_READY: "نسخه نهایی آماده تأیید شماست",
  CONFIRMED: "فهرست نهایی تأیید شده است",
} as const;
