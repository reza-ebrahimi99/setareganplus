...
import { documentVerifyLabel, toDocumentVerifyUi } from "@/lib/guidance/documents/verification-gate";
      ...
      title:
        d.documentType === "FINAL_GRADES"
          ...
          : d.documentType === "EXAM_RESULT"
            ? "کارنامه کنکور"
            : d.documentType === "SANJESH_RECEIPT"
              ? "رسید سنجش"
              : d.documentType,
      filename: d.originalFilename,
      mimeType: d.mimeType,
      uploadedLabel: formatJalaliDateTimeShort(d.createdAt),
      verification: documentVerifyLabel(d.verificationStatus),
      verifyUi: toDocumentVerifyUi(d.verificationStatus),
      reviewNote: d.reviewNote,
      verifiedBy: d.verifiedBy
        ? `${d.verifiedBy.firstName} ${d.verifiedBy.lastName}`.trim()
        : null,
      verifiedLabel: d.verifiedAt ? formatJalaliDateTimeShort(d.verifiedAt) : null,
