...
const PUBLIC_PAGE_SEO: Record<PublicPageKey, CreatePageMetadataInput> = {
  ...
  about: {
    path: "/about",
    title: "درباره مؤسسه آموزشی ستارگان | از ۱۳۹۴ تا امروز",
    description:
      "داستان مؤسسه آموزشی ستارگان در نسیم‌شهر؛ از آموزش تقویتی و کنکور تا دبستان ستارگان آینده، نمایندگی قلم‌چی و خدمات دیجیتال SetareganPlus.",
    keywords: [
      "درباره مؤسسه ستارگان",
      "ستارگان پلاس",
      "دبستان ستارگان آینده",
      "قلم چی نسیم شهر",
    ],
