...
const PUBLIC_PAGE_SEO: Record<PublicPageKey, CreatePageMetadataInput> = {
  ...
  shop: {
    ...
    description:
      "فهرست جزوه‌ها و محصولات آموزشی ستارگان پلاس با امکان مشاهده مشخصات، قیمت و خرید آنلاین با تحویل حضوری.",
    keywords: ["فروشگاه آموزشی", "جزوه ستارگان", "خرید جزوه آموزشی", "کتاب و جزوه"],
  },
  contact: {
    path: "/contact",
  ...
  guidance: {
    ...
    description:
      "سامانه جامع انتخاب رشته دپارتمان قلم‌چی نسیم‌شهر؛ مسیر شخصی انتخاب رشته با هدایت مهندس رضا ابراهیمی.",
    keywords: [
      "انتخاب رشته",
