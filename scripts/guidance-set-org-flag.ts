#!/usr/bin/env tsx
/**
 * Operator helper: enable/disable the organization-scoped `guidance` flag.
 * Default remains OFF. Does not change STAROS_GUIDANCE_HARD_OFF.
 *
 * Usage:
 *   npm run guidance:set-flag -- --slug=setareganplus --enabled=true
 */
...
import { GUIDANCE_FEATURE_FLAG_KEY } from "../lib/guidance/constants";
